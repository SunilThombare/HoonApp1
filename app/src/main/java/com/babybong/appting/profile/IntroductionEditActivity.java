...
public class IntroductionEditActivity extends BaseActivity {
    ...
    private void setData() {
        inputIntroduction.setText(DataStoredService.getStoredData(IntroductionEditActivity.this, DataStoredService.STORE_INTRODUCTION));
        inputHobby.setText(DataStoredService.getStoredData(IntroductionEditActivity.this, DataStoredService.STORE_HOBBY));
        inputIdealType.setText(DataStoredService.getStoredData(IntroductionEditActivity.this, DataStoredService.STORE_IDEALTYPE));
        inputMyAppeal.setText(DataStoredService.getStoredData(IntroductionEditActivity.this, DataStoredService.STORE_MYAPPEAL));
    ...
    public void onClickSaveBtn(View view) {
        try {
            ...
            Toast.makeText(IntroductionEditActivity.this, e.toString(), Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    }

    private void saveIntroduction() throws Exception {
        final String mail = DataStoredService.getStoredData(IntroductionEditActivity.this, DataStoredService.STORE_MAIL);
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.PUT, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            private void dataStore() {
                DataStoredService.storeData(IntroductionEditActivity.this, DataStoredService.STORE_INTRODUCTION, introduction);
                DataStoredService.storeData(IntroductionEditActivity.this, DataStoredService.STORE_HOBBY, hobby);
                DataStoredService.storeData(IntroductionEditActivity.this, DataStoredService.STORE_IDEALTYPE, idealType);
                DataStoredService.storeData(IntroductionEditActivity.this, DataStoredService.STORE_MYAPPEAL, myAppeal);
